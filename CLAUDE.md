...
- **pnpm** as the package manager (required: `pnpm >= 10.0.0`, currently using `pnpm@10.33.0`)
...
The root `package.json` specifies `"packageManager": "pnpm@10.33.0"`, which enforces this specific version of pnpm via Corepack. To enable Corepack:
